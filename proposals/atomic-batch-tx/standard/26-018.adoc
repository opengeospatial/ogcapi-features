:Title: OGC API - Features - Part 11: Atomic and Batch Transactions
:titletext: OGC API - Features - Part 11: Atomic and Batch Transactions
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/ogcapi-features-11/1.0
|Internal reference number of this OGC(R) document: 26-018
|Version: 1.0.0-draft
...
include::clause_7_async.adoc[]

include::clause_8_json.adoc[]
