...
OGC API - Features - Part 11: Atomic and Batch Transactions (hereafter also referred to as "this Standard" or "this document") defines the behavior of an API that allows resource instances to be added, replaced, modified and/or removed for a collection using atomic or batch semantics.
...
OGC API resource feature collection instance spatial data openapi transactions atomic batch insert update replace delete REST POST 
