...
Derived from the [WFS 3.0, Part 1, version 3.0.0-draft.1](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_requirement_class_core).
...
**7.2** [API landing page](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_api_landing_page)
...
**7.3** [API Definition](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_api_definition_2)
...
**7.4** [Declaration of conformance classes](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_declaration_of_conformance_classes)
* [ ] GET request at **/conformance** served
* [ ] Resonse content is based on OpenAPI schema [confClasses.yaml](https://raw.githubusercontent.com/opengeospatial/ogcapi-features/master/core/openapi/schemas/confClasses.yaml).
...
**7.5** [HTTP 1.1](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_http_1_1)
* [ ] Conforms to [HTTP 1.1](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#rfc2616), including correct use of [status codes](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#http_status_codes), headers, etc.
* [ ] Conforms to [HTTP over TLS](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#rfc2818), if HTTPS is used
* [ ] (recommended) Supports [entity tags](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#rfc2616)

**7.7** [Support for cross-origin requests](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#cross_origin)
* [ ] (recommended) If the server will be accessed from the browser, allow cross-origin requests.

**7.8** [Encodings](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_encodings_2)
* [ ] (recommended) HTML5
* [ ] (recommended) GeoJSON
* See [Media Types](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#mediatypes) for guidance
...
**7.9** [Coordinate reference systems](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_coordinate_reference_systems)
...
**7.10** [Link headers](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_link_headers)
* [ ] (recommended) All links in response payloads are included as Link headers as well.

**7.11** [Feature collection**s** metadata](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_feature_collections_metadata)
...
**7.12** [Feature collection metadata](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_feature_collection_metadata)
...
**7.13** [Feature collections](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_feature_collections)
...
**7.14** [Feature](https://cdn.rawgit.com/opengeospatial/ogcapi-features/3.0.0-draft.1/docs/17-069.html#_feature_2)
