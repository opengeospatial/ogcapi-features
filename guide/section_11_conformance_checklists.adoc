...
* [ ] Response content is based on OpenAPI schema [conf-classes.yaml](https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/openapi/schemas/conf-classes.yaml).
