...
This clause specifies a set of standardized spatial comparison functions that can be used to evaludate whether a specific spatial relationship exists between a pair of geometries.  
...
* `*` representing a value that is not relevant to the evalutation of a spatial comparison function.
