...
=== Requirements Class "Basic Spatial Relation Functions"

include::requirements/requirements_class_basic-spatial-relations.adoc[]
...
In this conformance class, the only required spatial comparison function is _intersects_ and the only required spatial data types are point and BBox. Additional spatial comparison functions and spatial data types are specified in the <<rc_spatial-relations,Spatial Relation Functions>> requirements class.

include::requirements/basic-spatial-relations/REQ_spatial-predicate.adoc[]

include::requirements/basic-spatial-relations/REQ_spatial-relations.adoc[]

include::recommendations/basic-spatial-relations/PER_spatial-predicates.adoc[]

include::recommendations/basic-spatial-relations/PER_spatial-data-types.adoc[]
...
include::requirements/requirements_class_spatial-relations.adoc[]
...
include::requirements/spatial-relations/REQ_spatial-data-types.adoc[]
...
include::requirements/spatial-relations/REQ_spatial-relations.adoc[]
...
include::requirements/requirements_class_temporal-relations.adoc[]
...
include::requirements/temporal-relations/REQ_temporal-predicates.adoc[]

include::requirements/temporal-relations/REQ_temporal-relations.adoc[]

include::recommendations/temporal-relations/PER_temporal-predicates.adoc[]
...
include::requirements/requirements_class_array-relations.adoc[]
...
include::requirements/array-relations/REQ_array-predicates.adoc[]

include::recommendations/array-relations/PER_array-predicates.adoc[]
