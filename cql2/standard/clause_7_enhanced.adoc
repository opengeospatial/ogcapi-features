...
[[extended-basic-spatial-function]]
=== Requirements Class "Extended Basic Spatial Functions"

include::requirements/requirements_class_extended-basic-spatial-functions.adoc[]
...
==== Extended spatial data types and literal values
...
In this conformance class, the only required spatial comparison function is _intersects_.

include::requirements/extended-basic-spatial-functions/REQ_spatial-predicate.adoc[]

include::requirements/extended-basic-spatial-functions/REQ_spatial-functions.adoc[]

include::recommendations/extended-basic-spatial-functions/PER_spatial-predicates.adoc[]

include::recommendations/extended-basic-spatial-functions/PER_spatial-data-types.adoc[]
