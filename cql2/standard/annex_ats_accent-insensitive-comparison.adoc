...
|Requirements: | <<req_{conf-class}_accenti-constructor,/req/{conf-class}/accenti-constructor>>
|Test purpose: | Test the ACCENTI constructor in comparisons
|Test method: | 
Given:
...
|Test id: | /conf/{conf-class}/{conf-test}
|Requirements: | <<req_{conf-class}_accenti-constructor,/req/{conf-class}/accenti-constructor>>
|Test purpose: | Test the ACCENTI constructor in LIKE predicates
|Test method: | 
Given:
...
|Test id: | /conf/{conf-class}/{conf-test}
|Requirements: | <<req_{conf-class}_accenti-constructor,/req/{conf-class}/accenti-constructor>>
|Test purpose: | Test the ACCENTI constructor with the CASEI constructor 
|Test method: | 
Given:
...
|Test id: | /conf/{conf-class}/{conf-test}
|Requirements: | <<req_{conf-class}_accenti-constructor,/req/{conf-class}/accenti-constructor>>
|Test purpose: | Test the ACCENTI constructor with the CASEI constructor in LIKE predicates
|Test method: | 
Given:
