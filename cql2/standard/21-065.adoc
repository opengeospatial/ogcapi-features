...
:titletext: Common Query Language (CQL2)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/cql2/1.0
...
include::clause_6_basic_cql2.adoc[]

include::clause_7_enhanced.adoc[]
