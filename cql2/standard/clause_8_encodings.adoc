...
include::requirements/cql2-text/REQ_array-functions.adoc[]
...
include::requirements/cql2-json/REQ_temporal-functions.adoc[]

include::requirements/cql2-json/REQ_array-functions.adoc[]
...
This document does not specifically define an XML-encoding for CQL2. However, it is recognized that XML is still in common use and so implementers are directed to review the http://docs.opengeospatial.org/is/09-026r2/09-026r2.html[OGC Filter Encoding 2.0] standard which defines an XML-encoding for filter expressions that closely matches most of the functionality of CQL2.
