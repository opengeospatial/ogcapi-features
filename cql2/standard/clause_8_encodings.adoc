...
include::requirements/cql2-text/REQ_basic-spatial-relations.adoc[]

include::requirements/cql2-text/REQ_spatial-relations.adoc[]

include::requirements/cql2-text/REQ_temporal-relations.adoc[]

include::requirements/cql2-text/REQ_array-relations.adoc[]
...
include::requirements/cql2-json/REQ_basic-spatial-relations.adoc[]

include::requirements/cql2-json/REQ_spatial-relations.adoc[]

include::requirements/cql2-json/REQ_temporal-relations.adoc[]

include::requirements/cql2-json/REQ_array-relations.adoc[]
