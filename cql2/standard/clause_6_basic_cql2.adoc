...
on the operator. An operand is either a literal, a constructor, a function 
...
* Support for the `CASEI` constructor is added by requirements class <<rc_case-insensitive-comparison,Case-insensitive Comparison>>;
* Support for the `ACCENTI` constructor is added by requirements class <<rc_accent-insensitive-comparison,Accent-insensitive Comparison>>;
