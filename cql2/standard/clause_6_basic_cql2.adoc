...
* The rule `spatialPredicate` is added by requirements classes <<rc_basic-spatial-relations,Basic Spatial Relation Functions>> and <<rc_spatial-relations,Spatial Relation Functions>>;
* The rule `temporalPredicate` is added by requirements class <<rc_temporal-relations,Temporal Relation Functions>>.
* The rule `arrayPredicate` is added by requirements class <<rc_array-relations,Array Relation Functions>>;
