...
* support at least the conformance classes "Case-insensitive comparison", "Spatial relation functions" and "Temporal relation functions" (including all dependencies).
...
include::annex_ats_basic-spatial-relations.adoc[]

include::annex_ats_spatial-relations.adoc[]

include::annex_ats_temporal-relations.adoc[]

include::annex_ats_array-relations.adoc[]
