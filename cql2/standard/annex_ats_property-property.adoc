...
|Spatial Operators |ne_110m_admin_0_countries |`S_INTERSECTS(POLYGON\((0 40,10 40,10 50,0 50,0 40)),geom)` |8
|Spatial Operators |ne_110m_admin_0_countries |`S_INTERSECTS(LINESTRING(0 40,10 50),geom)` |4
|Spatial Operators |ne_110m_populated_places_simple |`S_INTERSECTS(POLYGON\((0 40,10 40,10 50,0 50,0 40)),geom)` |7
|Spatial Operators |ne_110m_rivers_lake_centerlines |`S_INTERSECTS(LINESTRING(-60 -90,-60 90),geom)` |2
