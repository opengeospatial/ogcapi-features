...
|Requirements: | <<req_{conf-class}_casei-constructor,/req/{conf-class}/casei-constructor>>
|Test purpose: | Test the CASEI constructor in comparisons
|Test method: | 
Given:
...
|Test id: | /conf/{conf-class}/{conf-test}
|Requirements: | <<req_{conf-class}_casei-constructor,/req/{conf-class}/casei-constructor>>
|Test purpose: | Test the CASEI constructor in LIKE predicates
|Test method: | 
Given:
...
Evaluate each predicate in <<test-data-predicates-casei-constructor>>, if the conditional dependency is met.
...
[[test-data-predicates-casei-constructor]]
