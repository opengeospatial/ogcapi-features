...
:titletext: OGC API - Features - Part 1: Core
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document:    17-069r2
|Version: link:http://docs.opengeospatial.org/DRAFTS/17-069r2.html[1.0.0-SNAPSHOT (Editor's draft)]
|Latest Published Draft: link:https://github.com/opengeospatial/WFS_FES/releases/download/1.0.0-draft.1/17-069r1_OGC_API_-_Features_-_Part_1_Core.html[1.0.0-draft.1]
