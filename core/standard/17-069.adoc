...
|Version: link:http://docs.opengeospatial.org/DRAFTS/17-069r1.html[1.0.0-SNAPSHOT (Editor's draft)]
|Latest Published Draft: link:https://rawcdn.githack.com/opengeospatial/WFS_FES/3.0.0-draft.1/docs/17-069.html[WFS 3.0.0-draft.1]
