...
|Version: 3.0.0-SNAPSHOT (Editor's draft)
|Latest Published Draft: link:https://rawcdn.githack.com/opengeospatial/WFS_FES/3.0.0-draft.1/docs/17-069.html[3.0.0-draft.1]
