...
|Internal reference number of this OGC(R) document: 17-069r4
|Version: link:http://docs.opengeospatial.org/DRAFTS/17-069r4.html[1.0.1-SNAPSHOT (Editor's draft)]
|Latest Published Version: link:http://docs.opengeospatial.org/is/17-069r3/17-069r3.html[1.0.0]
