...
|Internal reference number of this OGC(R) document:    17-069r3
|Version: link:http://docs.opengeospatial.org/DRAFTS/17-069r3.html[1.0.0-SNAPSHOT (Editor’s draft)]
|Latest Published Draft: link:http://docs.opengeospatial.org/DRAFTS/17-069r2.html[1.0.0-draft.2]
