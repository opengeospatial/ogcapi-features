...
include::core/ATS_fc-bbox-definition.adoc[]

include::core/ATS_fc-bbox-response.adoc[]

include::core/ATS_fc-limit-definition.adoc[]

include::core/ATS_fc-limit-response.adoc[]

include::core/ATS_fc-time-definition.adoc[]

include::core/ATS_fc-time-response.adoc[]
