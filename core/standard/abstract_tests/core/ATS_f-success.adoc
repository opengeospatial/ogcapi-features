...
|HTML |link:http://schemas.opengis.net/ogcapi/features/part1/1.0/schemas/featureGeoJSON.yaml[featureGeoJSON.yaml] |<<ats_html_content,/ats/html/content>>
|GeoJSON |link:http://schemas.opengis.net/ogcapi/features/part1/1.0/schemas/featureGeoJSON.yaml[featureGeoJSON.yaml] |<<ats_geojson_content,/ats/geojson/content>>
