...
|HTML |featureGeoJSON.yaml |<<ats_html_content,/ats/html/content>>
|GeoJSON |featureGeoJSON.yaml |<<ats_geojson_content,/ats/geojson/content>>
|GMLSF0 |featureGML.xsd |<<ats_gmlsf0_content,/ats/gmlsf0/content>>
|GMLSF2 |featureGML.xsd |<<ats_gmlsf2_content,/ats/gmlsf2/content>>
|===
