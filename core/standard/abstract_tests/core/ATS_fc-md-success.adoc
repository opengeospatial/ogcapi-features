...
|GMLSF0 |link:https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/xml/core.xsd[core.xsd], element `core:Collections` |<<ats_gmlsf0_content,/ats/gmlsf0/content>>
|GMLSF2 |link:https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/xml/core.xsd[core.xsd], element `core:Collections` |<<ats_gmlsf2_content,/ats/gmlsf2/content>>
|===
