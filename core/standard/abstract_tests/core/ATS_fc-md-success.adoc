...
|HTML |collections.yaml |<<ats_html_content,/ats/html/content>>
|GeoJSON |collections.yaml |<<ats_geojson_content,/ats/geojson/content>>
|GMLSF0 |collections_SF0.xsd |<<ats_gmlsf0_content,/ats/gmlsf0/content>>
|GMLSF2 |collections_SF2.xsd |<<ats_gmlsf2_content,/ats/gmlsf2/content>>
|===
