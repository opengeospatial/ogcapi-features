...
|HTML |link:https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/openapi/schemas/collection.yaml[collection.yaml] |Manual Inspection
|GeoJSON |link:https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/openapi/schemas/collection.yaml[collection.yaml] |<<ats_geojson_content,/ats/geojson/content>>
