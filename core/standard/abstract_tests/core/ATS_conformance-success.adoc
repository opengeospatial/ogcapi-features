...
^|Test Method |. Validate the response document against OpenAPI 3.0 schema link:https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/openapi/schemas/confClasses.yaml[confClasses.yaml]
