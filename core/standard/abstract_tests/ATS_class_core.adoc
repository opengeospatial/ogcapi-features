...
==== Collections Metadata {root}/collections

include::core/ATS_fc-md-op.adoc[]

include::core/ATS_fc-md-success.adoc[]

==== Simple Features Collection {root}/collections/{collectionId}

include::core/ATS_sf-md-op.adoc[]

include::core/ATS_sf-md-success.adoc[]

==== Collection (singular) Metadata {root}/collections/{collectionId}/items

include::core/ATS_fc-op.adoc[]

////
//// referenced does file not exist (yet)
//// include::core/ATS_fc-success.adoc[]
////
