...
^|Test Method |Verify that for each operation, the OpenAPI document describes all link:http://spec.openapis.org/oas/v3.0.3#http-status-codes[HTTP Status Codes] that can be generated.
|===
