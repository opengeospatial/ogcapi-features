...
|2019-02-14 |3.0.0-SNAPSHOT |C. Portele, C. Holmes |6,7,C |Bugfixes link:https://github.com/opengeospatial/WFS_FES/issues/149[#149] and link:https://github.com/opengeospatial/WFS_FES/issues/176[#176], change rel=item to rel=items link:https://github.com/opengeospatial/WFS_FES/pull/175[#175]
|===
