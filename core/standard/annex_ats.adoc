...
Only features that have a temporal geometry that intersects the timestamp or time period SHALL be part of the result set, if the datetime parameter is provided. +
The temporal information is either a date-time or a period string. Date and time expressions adhere to RFC 3339. +
