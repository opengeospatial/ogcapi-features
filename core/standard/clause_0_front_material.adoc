...
|Feature collections |`/collections` |GET |<<_feature_collections,7.11 Feature collections>>
|Feature collection metadata |`/collections/{collectionId}` |GET |<<_feature_collection_metadata, 7.12 Feature collection metadata>>
|Feature collection |`/collections/{collectionId}/items` |GET |<<_feature_collection,7.13 Feature collection>>
