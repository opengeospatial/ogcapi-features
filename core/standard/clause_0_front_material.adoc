...
Remove `/api` row, if the API definition may be located at any URI.
...
CAUTION: link:https://github.com/opengeospatial/WFS_FES/issues/224[ISSUE 224] +
Update submitters before publication.
