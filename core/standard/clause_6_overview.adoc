...
comfortable with using a JSON-based format, this version of OGC API
Features <<rec_geojson,recommends supporting GeoJSON for encoding feature data>>,
...
https://github.com/opengeospatial/ogcapi-features/blob/master/core/examples.
