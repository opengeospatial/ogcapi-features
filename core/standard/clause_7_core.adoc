...
sub-clause <<security,Security>>) or where HTTP redirection is used.
...
SHALL be based upon the schema https://raw.githubusercontent.com/cportele/wfs-openapi/master/core/schemas/exception.yaml.
|===

The exception schema supports both JSON and XML encodings:

.link:https://raw.githubusercontent.com/cportele/wfs-openapi/master/core/schemas/exception.yaml[Schema for exceptions]
[source,YAML]
----
type: object
required:
...
HTTP status code "200" based upon the schema https://raw.githubusercontent.com/cportele/wfs-openapi/master/core/schemas/content.yaml.
|===
...
https://raw.githubusercontent.com/cportele/wfs-openapi/master/core/schemas/timeStamp.yaml.
|===

The exception schema supports both JSON and XML encodings:

.link:https://raw.githubusercontent.com/cportele/wfs-openapi/master/core/schemas/timeStamp.yaml[Schema for the timeStamp property]
[source,YAML]
----
timeStamp:
  ...
  /buildings/{id}:
    get:
      ...
      tags:
        - Features
      parameters:
        - $ref: https://raw.githubusercontent.com/cportele/wfs-openapi/master/core/parameters/id.yaml
