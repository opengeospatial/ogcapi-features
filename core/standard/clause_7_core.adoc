...
Each `Collection` (path `/collections/{collectionId}/items`) consists of the features in the collection where each
...
`datetime=2018-02-12T00%3A00%3A00Z%2FP1M6DT12H31M12S`
=================
...
a bounding box;
* if parameter `datetime` is not a valid time stamp or time period.
