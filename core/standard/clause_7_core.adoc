...
A server that implements this conformance class provides access to the features in a link:https://www.w3.org/TR/vocab-dcat/#class-dataset[dataset]. In other words, the API is a link:https://www.w3.org/TR/vocab-dcat/#class-distribution[distribution] of that dataset. A file download, for example, would be another distribution.
...
[[schema_landingPage]]
.link:http://schemas.opengis.net/ogcapi/features/part1/1.0/schemas/landingPage.yaml[Schema for the landing page]
[source,YAML]
----
type: object
required:
...
properties:
  ...
  links:
    type: array
    items:
      $ref: http://schemas.opengis.net/ogcapi/features/part1/1.0/schemas/link.yaml
----
...
[[schema_confClasses]]
.link:http://schemas.opengis.net/ogcapi/features/part1/1.0/schemas/confClasses.yaml[Schema for the list of conformance classes]
[source,YAML]
----
type: object
required:
...
[[schema_collections]]
.link:http://schemas.opengis.net/ogcapi/features/part1/1.0/schemas/collections.yaml[Schema for the collections resource]
[source,YAML]
----
type: object
required:
...
properties:
  ...
  collections:
    type: array
    items:
      $ref: http://schemas.opengis.net/ogcapi/features/part1/1.0/schemas/collection.yaml
----
...
[[schema_collection]]
.link:http://schemas.opengis.net/ogcapi/features/part1/1.0/schemas/collection.yaml[Schema for a feature collection]
[source,YAML]
----
type: object
required:
...
A template for the definition of the parameter in YAML according to OpenAPI 3.0 is available at link:http://schemas.opengis.net/ogcapi/features/part1/1.0/parameters/limit.yaml[limit.yaml].
...
A template for the definition of the parameter in YAML according to OpenAPI 3.0 is available at link:http://schemas.opengis.net/ogcapi/features/part1/1.0/parameters/bbox.yaml[bbox.yaml].
...
A template for the definition of the parameter in YAML according to OpenAPI 3.0 is available at link:http://schemas.opengis.net/ogcapi/features/part1/1.0/parameters/datetime.yaml[datetime.yaml].
