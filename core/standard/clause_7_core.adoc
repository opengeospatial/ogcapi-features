...
[[schema_landingPage]]
.link:https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/openapi/schemas/landingPage.yaml[Schema for the landing page]
[source,YAML]
----
type: object
required:
...
itself, but it can be hosted as a sub-resource to the base path of the API,
for example, at path `/api`. Note that in that case there is no need to include
...
[[schema_conf-classes]]
.link:https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/openapi/schemas/conf-classes.yaml[Schema for the list of conformance classes]
[source,YAML]
----
type: object
required:
...
The link:https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/openapi/schemas/link.yaml[link object]
...
NOTE: The registration of http://www.opengis.net/def/crs/OGC/0/CRS84h is in process.
This note will be removed once the CRS has been registered by the OGC Naming Authority
and the URI resolves to the CRS definition.
...
[[schema_collections]]
.link:https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/openapi/schemas/collections.yaml[Schema for the collections resource]
[source,YAML]
----
type: object
required:
...
properties:
  ...
  collections:
    type: array
    items:
      $ref: https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/openapi/schemas/collection.yaml
----
...
[[schema_collection]]
.link:https://raw.githubusercontent.com/opengeospatial/WFS_FES/master/core/openapi/schemas/collection.yaml[Schema for a feature collection]
[source,YAML]
----
type: object
required:
