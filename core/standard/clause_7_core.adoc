...
NOTE: http://www.opengis.net/def/crs/OGC/0/tbd is a placeholder until the
CRS has been registered by the OGC Naming Authority.
...
or http://www.opengis.net/def/crs/OGC/0/tbd (for coordinates with
