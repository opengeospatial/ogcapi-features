...
|Feature collection metadata |`/collections/{name}` |`wfs:Collection`
...
The API definition resource at path `/api` is not included in <<gml_content>> and
as this requirements class does not prescribe any API definition approach.
