...
CAUTION: link:https://github.com/opengeospatial/WFS_FES/issues/58[ISSUE 58] +
Add and describe XML schema for XML/GML responses. Clarify the mapping of the
resources from Core to the XML schema. Add examples.
...
CAUTION: link:https://github.com/opengeospatial/WFS_FES/issues/58[ISSUE 58] +
See the same note in the "Geography Markup Language (GML), Simple Features Profile,
Level 0" requirements class above.
