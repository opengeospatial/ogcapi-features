...
^|C |The schema of all responses with a root element in the `core` namespace SHALL validate against the link:https://raw.githubusercontent.com/opengeospatial/ogcapi-features/master/core/xml/core.xsd[OGC API Features Core XML Schema].
|===
