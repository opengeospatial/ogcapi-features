...
^|D |The content of all responses with a root element in the `sf` namespace SHALL validate against the link:http://schemas.opengis.net/ogcapi/features/part1/1.1/xml/core-sf.xsd[OGC API Features Core GML Simple Features XML Schema].
|===
