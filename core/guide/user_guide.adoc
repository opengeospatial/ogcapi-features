...
|Editor:   Charles Heazel, Charles (Chuck) Heazel
|===
...
include::section_7_WFS_2_0_v_3_0.adoc[]

include::section_8_OpenAPI_v_Capabilities.adoc[]

include::section_9_information_assurance.adoc[]

include::section_10_tbd.adoc[]

include::section_11_tbd.adoc[]

<<<
include::annex_a_tbd.adoc[]

<<<
include::annex_b_changes_to_the_previous_version.adoc[]
