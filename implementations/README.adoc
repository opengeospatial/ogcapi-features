...
| link:servers/mapserver.md[mapserver]
| `core`, `oas30`, `geojson`, `html`, `crs`, `queryables`, `queryables-query-parameters`, `filter`.
| -
| -
| https://mapserver.org/community/index.html/[List of contacts]
|
|===
