...
|Version: link:http://docs.ogc.org/DRAFTS/23-058r3.html[{m_n_o} (Editor's draft)]
|Latest Published Version: https://docs.ogc.org/is/23-058r2/23-058r2.html[1.0.0]
|Internal reference number of this OGC(R) document:    23-058r3
...
include::clause_16_profile_domains.adoc[]

include::clause_17_media_types.adoc[]

include::clause_18_security_considerations.adoc[]
