...
The Requirements Class "Queryables" specifies the web resources representing the schema with the <<queryable-def,queryable>> properties of a collection returned by Web API endpoint(s) implementing OGC API Standards.
