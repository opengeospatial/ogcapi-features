...
For cases where the properties of the data must be ordered in some representations of the data, the sequence of the properties can be expressed using a keyword "x-ogc-property-seq".
...
NOTE: UCUM provides a language to define units while QUDT provides a units of measure vocabulary. The term "language" is used as it is the broader term.
