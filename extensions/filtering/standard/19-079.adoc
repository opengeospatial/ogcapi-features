...
:titletext: OGC API - Features - Part 3: Filtering
:standard: ogcapi-features-3
:m_n: 1.0
:doctype: book
:encoding: utf-8
:lang: en
...
include::clause_6_queryables.adoc[]

include::clause_7_queryables-query-parameters.adoc[]

include::clause_8_filter.adoc[]
