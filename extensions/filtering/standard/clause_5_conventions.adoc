...
As an alternative, the https://docs.ogc.org/pol/09-048r6.html#toc14[Compact URI (CURIE)] **[ogc-rel:queryables]** can be used, too, where a CURIE is an allowed value, too.
