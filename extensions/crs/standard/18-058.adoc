...
:titletext: OGC API - Features - Part 2: Coordinate Reference Systems by Reference
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document:    18-058r1
|Version: 1.0.1-SNAPSHOT (Editor's draft)
|Latest Published Version: https://docs.opengeospatial.org/is/18-058/18-058.html[1.0.0]
