:Title: OGC API - Features - Part 6: Property Selection
:titletext: OGC API - Features - Part 6: Property Selection
:standard: ogcapi-features-6
:m_n: 1.0
...
|Internal reference number of this OGC(R) document:    24-019
|Version: {m_n_o}
...
include::clause_6_properties.adoc[]

include::clause_7_properties_features.adoc[]
