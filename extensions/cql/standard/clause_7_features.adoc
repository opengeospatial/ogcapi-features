...
This clause defines the binding between the <<OAFeat-1,OGC API - Features - Part 1: Core>> standard and the <<rc_filter,filtering parameters>> defined in this standard.
...
// TODO include::requirements/features-filter/REQ_cql-text.adoc[]

include::recommendations/features-filter/REC_json-encoding.adoc[]

// TODO include::requirements/features-filter/REQ_cql-json.adoc[]
