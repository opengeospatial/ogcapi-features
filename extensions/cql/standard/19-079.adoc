...
:titletext: OGC API - Features - Part 3: Filtering and the Common Query Language (CQL)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/ogcapi-features-3/1.0
|Internal reference number of this OGC(R) document:    19-079
|Version: link:https://htmlpreview.github.io/?https://github.com/opengeospatial/ogcapi-features/blob/part3-1.0.0-draft.1/extensions/cql/standard/19-079.html[1.0.0-draft.1]
...
include::clause_6_filter.adoc[]

include::clause_7_features.adoc[]

include::clause_8_simple_cql.adoc[]

include::clause_9_enhanced.adoc[]
