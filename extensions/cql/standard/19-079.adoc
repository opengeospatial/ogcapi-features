...
:titletext: OGC API - Features - Part 3: Filtering and the Common Query Language (CQL2)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document:    19-079r1
...
// TODO: rename later to basic_cql2 after open PRs on clause 8 have been merged 
