...
expressions can be tested in a predicate for equality, if one array is a subset of another, it one array is a superset of another or is two arrays overlaps or share elements.
