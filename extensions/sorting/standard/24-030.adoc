:Title: OGC API - Features - Part 8: Sorting
:titletext: OGC API - Features - Part 8: Sorting
:standard: ogcapi-features-8
:m_n: 1.0
:doctype: book
:encoding: utf-8
:lang: en
...
|Internal reference number of this OGC(R) document:    24-030
|Version: {m_n}.0-SNAPSHOT
...
include::clause_6_sortables.adoc[]

include::clause_7_sorting.adoc[]
