:Title: OGC API - Features - Part 7: Geometry Simplification
:titletext: OGC API - Features - Part 7: Geometry Simplification
:standard: ogcapi-features-7
:m_n: 1.0
...
|Internal reference number of this OGC(R) document:    24-020
|Version: {m_n_o}
...
include::clause_6_zoom_level.adoc[]

include::clause_7_zoom_level_features.adoc[]
