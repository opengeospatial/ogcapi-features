...
* [[LDP]] World Wide Web Consortium (W3C). **Linked Data Platform 1.0** [online]. Edited by S. Speicher, J. Arwe, A. Malhotra. 2015 [viewed 2026-08-21]. Available at https://www.w3.org/TR/ldp/ (the specification of the `Accept-Post` header field, which is registered in the IANA HTTP Field Name Registry)
...
* [[rfc7240]] Internet Engineering Task Force (IETF). RFC 7240: **Prefer Header for HTTP** [online]. Edited by J. Snell. 2014 [viewed 2026-08-20]. Available at https://www.rfc-editor.org/rfc/rfc7240
