...
|Internal reference number of this OGC(R) document:    20-002r2
...
include::clause_9_return-resource-representation-in-response.adoc[]

include::clause_10_handling.adoc[]

include::clause_11_features.adoc[]
