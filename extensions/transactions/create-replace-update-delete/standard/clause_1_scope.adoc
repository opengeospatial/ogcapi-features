...
* How to modify an existing resource from a collection: This includes entirely replacing the existing resource (replace, a complete update) or modifying parts of the resource (update, a partial update).
