...
The status code depends on the server. If the server has replaced the resource, the response is either `200` if the response includes additional content, or `204` if the response has no additional content. 
