:Title: OGC API - Features - Part 4: Simple Transactions
:titletext: OGC API - Features - Part 4: Simple Transactions
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document:    20-002
|Version: link:http://docs.opengeospatial.org/DRAFTS/20-002.html[1.0.0-SNAPSHOT (Editor's draft)]
...
include::clause_6_simpletx.adoc[]

include::clause_7_patch.adoc[]

include::clause_8_features.adoc[]
