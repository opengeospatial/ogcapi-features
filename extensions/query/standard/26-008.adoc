:Title: OGC API - Features - Part 10: Query
:titletext: OGC API - Features - Part 10: Query 
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/ogcapi-features-10/1.0
|Internal reference number of this OGC(R) document:    26-008
|Version: link:http://docs.opengeospatial.org/DRAFTS/26-008.html[0.1 (Editor's draft)]
...
include::clause_06_adhoc-query.adoc[]
include::clause_07_stored-query.adoc[]
include::clause_08_response.adoc[]
include::clause_09_parameterized-stored-query.adoc[]
include::clause_10_manage-stored-query.adoc[]
include::clause_11_query_expressions.adoc[]
include::clause_12_http-query-method.adoc[]
include::clause_13_media_types.adoc[]
include::clause_14_security_considerations.adoc[]
