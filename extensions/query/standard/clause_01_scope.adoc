...
1.3+|/query |GET |Get the list of stored queries. |<<clause-stored-query,Stored query>>
1+|POST  |Execute an ad-hoc query using the HTTP POST method. |<<clause-adhoc-query,Adhoc query>>
1+|QUERY  |Execute an ad-hoc query using the HTTP QUERY method. |<<http-query-method-ad-hoc,The HTTP QUERY method>>

1.5+|/query/{queryId} |GET |Execute this stored query. |<<clause-stored-query,Stored query>>
1+|POST   |Execute this stored query with an application/x-www-form-urlencoded body. |<<clause-stored-query,Stored query>>
1+|QUERY  |Execute this stored query with an application/x-www-form-urlencoded body using the the HTTP QUERY method. |<<http-query-method-parameterized-stored-query,The HTTP QUERY method>>
...
|/query/{queryId}/parameters/{parameterId} |GET |Get the definition of this query parameter. |<<clause-parameterized-stored-query-parameter-discovery,Retrieving the definition of a query parameter>>
|====
